...
class __TwigTemplate_de337669f57fa8940cc67fd0a4909a1accdcab1f2d70121ffb40e21474b54234 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["profile"]) || array_key_exists("profile", $context) ? $context["profile"] : (function () { throw new RuntimeError('Variable "profile" does not exist.', 267, $this->source); })()), "children", [], "any", false, false, false, 267))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                ...
                echo "\">
                            ";
                // line 275
                echo twig_call_macro($macros["helper"], "macro_set_handler", [twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["child"], "getcollector", [0 => "request"], "method", false, false, false, 275), "controller", [], "any", false, false, false, 275)], 275, $context, $this->getSourceContext());
                echo "
                        </a>
                        <small>(token = <a href=\"";
                // line 277
...
{% macro set_handler(controller, route, method) %}
    ...
    {%- endif %}
{% endmacro %}
", "@WebProfiler/Collector/request.html.twig", "/home/guillaumeg/Periodico/la_ilustracion/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/request.html.twig");
    }
}
