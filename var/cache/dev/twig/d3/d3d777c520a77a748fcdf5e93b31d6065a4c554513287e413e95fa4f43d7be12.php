...
class __TwigTemplate_79351d2e6c10824df30ff473b9e6ad652431d56b7edd54f768eacde583ab50da extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    ";
        echo twig_include($this->env, $context, "/user/_login.html.twig", ["last_username" => (isset($context["last_username"]) || array_key_exists("last_username", $context) ? $context["last_username"] : (function () { throw new RuntimeError('Variable "last_username" does not exist.', 4, $this->source); })())], false);
        echo "
    ";
        // line 5
...
{% block body %}
    {{ include('/user/_login.html.twig', {'last_username': last_username}, false) }}
    {% if error %}
