...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\Type\\CommentType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\Type\\CommentType']) ? $this->services['AppBundle\\Form\\Type\\CommentType'] : ($this->services['AppBundle\\Form\\Type\\CommentType'] = new \AppBundle\Form\Type\CommentType())) && false ?: '_'};
    ...
    return ${($_ = isset($this->services['AppBundle\\Form\\Type\\PostEditType']) ? $this->services['AppBundle\\Form\\Type\\PostEditType'] : ($this->services['AppBundle\\Form\\Type\\PostEditType'] = new \AppBundle\Form\Type\PostEditType())) && false ?: '_'};
}, 'AppBundle\\Form\\Type\\PostType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\Type\\PostType']) ? $this->services['AppBundle\\Form\\Type\\PostType'] : ($this->services['AppBundle\\Form\\Type\\PostType'] = new \AppBundle\Form\Type\PostType())) && false ?: '_'};
}, 'AppBundle\\Form\\Type\\UserEditProfileType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\Type\\UserEditProfileType']) ? $this->services['AppBundle\\Form\\Type\\UserEditProfileType'] : ($this->services['AppBundle\\Form\\Type\\UserEditProfileType'] = new \AppBundle\Form\Type\UserEditProfileType())) && false ?: '_'};
}, 'AppBundle\\Form\\Type\\UserRegistrationType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\Type\\UserRegistrationType']) ? $this->services['AppBundle\\Form\\Type\\UserRegistrationType'] : ($this->services['AppBundle\\Form\\Type\\UserRegistrationType'] = new \AppBundle\Form\Type\UserRegistrationType())) && false ?: '_'};
}, 'AppBundle\\Form\\Type\\UserUpdatePasswordType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\Type\\UserUpdatePasswordType']) ? $this->services['AppBundle\\Form\\Type\\UserUpdatePasswordType'] : ($this->services['AppBundle\\Form\\Type\\UserUpdatePasswordType'] = new \AppBundle\Form\Type\UserUpdatePasswordType())) && false ?: '_'};
